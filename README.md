...
- 目前工作集共 100 筆航班列：CI 43、AE 10、BR 19、B7 0、MU 23、FM 5。
- `verified` 53 筆：主要為 CI/AE，來自華航 2026 夏季班表 PDF。
- `needs_review` 47 筆：BR 需回到 EVA 官方查詢頁逐線重跑確認；MU/FM 來源為東航台灣官網 PDF，但該 PDF 版面/年代需再確認是否完全對應 2026 夏季季節。
- 方向完整性檢查目前只有 `NCH-TPE` 需複核；其餘航點對已具雙向資料。
